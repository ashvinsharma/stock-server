...
class MechanitisApplication

fun main(args: Array<String>) {
    runApplication<MechanitisApplication>(*args)
}
...
class PriceService {
    ...
    fun generatePrices(symbol: String): Flux<StockPrice> = Flux.interval(Duration.ofSeconds(1))
